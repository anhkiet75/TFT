...
<div class="container-fluid d-flex flex-column">
   ...
   <div class="d-flex justify-content-between mt-4">
      ...
      method="GET" action="/equipment/search"
      >
         <input autocomplete="off" type="search" class="form-control rounded" placeholder='Search ID or Serial Number' style="min-width: 250px" name="id" />
               ...
               <div class="modal-body">
                  ...
                  <form action="" method="post" id="formUpdate">
                     ...
                     <div class="form-group d-flex flex-column">
                        ...
                        <select class="form-select" id="formUpdateUser" aria-label="Default select example" name="user_id">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-select" aria-label="Default select example" id="formUpdateCate" name="category_id">
